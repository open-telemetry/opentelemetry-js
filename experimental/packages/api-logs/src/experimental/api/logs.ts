...
import {
  ...
  _global,
  makeGetter,
  GLOBAL_EXPERIMENTAL_LOGS_API_KEY,
...
export class LogsAPI {
  ...
  public setGlobalLoggerProvider(provider: LoggerProvider): LoggerProvider {
    if (_global[GLOBAL_EXPERIMENTAL_LOGS_API_KEY]) {
      return this.getLoggerProvider();
    }
    _global[GLOBAL_EXPERIMENTAL_LOGS_API_KEY] = makeGetter<LoggerProvider>(
      API_BACKWARDS_COMPATIBILITY_VERSION,
      provider,
  ...
  public getLoggerProvider(): LoggerProvider {
    return (
      (_global[GLOBAL_EXPERIMENTAL_LOGS_API_KEY] as any)?.(
        API_BACKWARDS_COMPATIBILITY_VERSION
  ...
  public disable(): void {
    delete _global[GLOBAL_EXPERIMENTAL_LOGS_API_KEY];
