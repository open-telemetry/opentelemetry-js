...
* fix(instrumentation-http)!: do not normalize hyphens to underscores in captured header attribute names [#6381](https://github.com/open-telemetry/opentelemetry-js/issues/6381) @trentm
