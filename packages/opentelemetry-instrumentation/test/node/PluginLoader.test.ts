...
import { createNoopDiagLogger, NoopTracerProvider } from '@opentelemetry/api';
...
describe('PluginLoader', () => {
  ...
  describe('.state()', () => {
    it('returns UNINITIALIZED when first called', () => {
      const pluginLoader = new PluginLoader(provider, diagLogger);
  ...
  describe('.load()', () => {
    ...
    it('should warn when module was already loaded', callback => {
      const verifyWarnLogger = Object.assign({}, diagLogger);
