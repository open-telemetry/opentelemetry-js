...
* feat(sdk-node)!: drop SDK package re-exports (`api`, `contextBase`, `core`, `logs`, `metrics`, `resources`) [#XXXX](https://github.com/open-telemetry/opentelemetry-js/pull/XXXX) @marc-pichler
