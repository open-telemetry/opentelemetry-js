...
export class SyncInstrument {
  ...
  protected _record(value: number, attributes: metrics.SpanAttributes = {}, context: api.Context = api.context.active()) {
...
export class UpDownCounterInstrument extends SyncInstrument implements metrics.UpDownCounter {
   ...
   */
  add(value: number, attributes?: metrics.SpanAttributes, ctx?: api.Context): void {
...
export class HistogramInstrument extends SyncInstrument implements metrics.Histogram {
   ...
   */
  record(value: number, attributes?: metrics.SpanAttributes, ctx?: api.Context): void {
    this._record(value, attributes, ctx);
  }
}
