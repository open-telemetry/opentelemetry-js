...
| [`requestHook`](https://github.com/open-telemetry/opentelemetry-js/blob/main/experimental/packages/opentelemetry-instrumentation-fetch/src/fetch.ts#L85) | `FetchRequestCustomAttributeFunction` | Function for adding custom attributes or headers before the request is handled                                                  |
