...
describe('MeterProvider', () => {
  ...
  describe('getMeter', () => {
    ...
    it('should return the meter with default version without a version option', () => {
      const meterProvider = new MeterProvider();
      const meter1 = meterProvider.getMeter('default');
      const meter2 = meterProvider.getMeter('default', '*');
      assert.deepEqual(meter1, meter2);
    });

    it('should return the same Meter instance with same name & version', () => {
      const meterProvider = new MeterProvider();
      const meter1 = meterProvider.getMeter('meter1', 'ver1');
      const meter2 = meterProvider.getMeter('meter1', 'ver1');
      assert.deepEqual(meter1, meter2);
    });
    ...
    it('should return different Meter instance with different name or version', () => {
      ...
      const meter1 = meterProvider.getMeter('meter1', 'ver1');
      const meter2 = meterProvider.getMeter('meter1');
      assert.notEqual(meter1, meter2);

      const meter3 = meterProvider.getMeter('meter2', 'ver2');
      const meter4 = meterProvider.getMeter('meter3', 'ver2');
