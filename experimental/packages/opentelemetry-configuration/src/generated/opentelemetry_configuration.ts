...
export type OtlpFile1Development = {
...
export type ExperimentalPrometheusMetricExporter = {
  ...
  with_resource_constant_labels?: AttributeKeys;
} & ({
  host?: string | null;
  port?: number | null;
  without_units?: boolean | null;
...
export interface LogRecordExporter {
  otlp_http?: OtlpHttp;
  otlp_grpc?: OtlpGrpc;
  'otlp_file/development'?: OtlpFile1Development;
  console?: Console;
  [k: string]: unknown;
}
...
export interface AttributeKeys {
  included?: string[];
  excluded?: string[];
}
