...
describe('BinaryTraceContext', () => {
  ...
  const commonTraceId = new Uint8Array([0xd4, 0xcd, 0xa9, 0x5b, 0x65, 0x2f, 0x4a, 0x15, 0x92, 0xb4, 0x49, 0xd5, 0x92, 0x9f, 0xda, 0x1b]);
  const commonSpanId = new Uint8Array([0x75, 0xe8, 0xed, 0x49, 0x1a, 0xec, 0x7e, 0xca]);
