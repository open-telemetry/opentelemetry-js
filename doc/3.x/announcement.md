...
- **Drop unmaintained and deprecated packages**: packages such as `@opentelemetry/propagator-jaeger`, `@opentelemetry/instrumentation-restify`, and `@opentelemetry/shim-opencensus` are being removed to reduce maintenance burden.
