...
let _ExperimentalComposableRuleBasedSamplerRuleSchema: z.ZodTypeAny;
let _ExperimentalComposableRuleBasedSamplerSchema: z.ZodTypeAny;
let _ExperimentalComposableSamplerSchema: z.ZodTypeAny;
let _ExperimentalComposableParentThresholdSamplerSchema: z.ZodTypeAny;
let _ParentBasedSamplerSchema: z.ZodTypeAny;
let _SamplerSchema: z.ZodTypeAny;
let _ExperimentalJaegerRemoteSamplerSchema: z.ZodTypeAny;

export const ExperimentalComposableRuleBasedSamplerRuleSchema: z.ZodTypeAny =
  z.lazy(() => _ExperimentalComposableRuleBasedSamplerRuleSchema);
export const ExperimentalComposableRuleBasedSamplerSchema: z.ZodTypeAny =
  z.lazy(() => _ExperimentalComposableRuleBasedSamplerSchema);
export const ExperimentalComposableSamplerSchema: z.ZodTypeAny = z.lazy(
  () => _ExperimentalComposableSamplerSchema
);
export const ExperimentalComposableParentThresholdSamplerSchema: z.ZodTypeAny =
  z.lazy(() => _ExperimentalComposableParentThresholdSamplerSchema);
export const ParentBasedSamplerSchema: z.ZodTypeAny = z.lazy(
  () => _ParentBasedSamplerSchema
);
export const SamplerSchema: z.ZodTypeAny = z.lazy(() => _SamplerSchema);
export const ExperimentalJaegerRemoteSamplerSchema: z.ZodTypeAny = z.lazy(
  () => _ExperimentalJaegerRemoteSamplerSchema
);

export const DefaultAggregationSchema = z.union([
  z.null(),
  z.record(z.string(), z.never()),
]);

export const DropAggregationSchema = z.union([
  z.null(),
  z.record(z.string(), z.never()),
]);

export const ExplicitBucketHistogramAggregationSchema = z.union([
  z.null(),
  z
    .object({
      boundaries: z
...
export const Base2ExponentialBucketHistogramAggregationSchema = z.union([
  z.null(),
  z
    .object({
      max_scale: z
...
export const LastValueAggregationSchema = z.union([
  z.null(),
  z.record(z.string(), z.never()),
]);

export const SumAggregationSchema = z.union([
  z.null(),
  z.record(z.string(), z.never()),
]);
...
export const AggregationSchema = z
  .object({
    default: DefaultAggregationSchema.describe(
    ...
    drop: DropAggregationSchema.describe(
    ...
    explicit_bucket_histogram:
      ExplicitBucketHistogramAggregationSchema.describe(
    ...
    base2_exponential_bucket_histogram:
      Base2ExponentialBucketHistogramAggregationSchema.describe(
    ...
    last_value: LastValueAggregationSchema.describe(
    ...
    sum: SumAggregationSchema.describe(
...
export const AlwaysOffSamplerSchema = z.union([
  z.null(),
  z.record(z.string(), z.never()),
]);

export const AlwaysOnSamplerSchema = z.union([
  z.null(),
  z.record(z.string(), z.never()),
]);

export const AttributeLimitsSchema = z
  .object({
    attribute_value_length_limit: z
      .union([
        z
          .null()
          .describe(
...
export const AttributeNameValueSchema = z
  .object({
    name: z
      .string()
      .describe(
    ...
    type: AttributeTypeSchema.describe(
...
export const B3MultiPropagatorSchema = z.union([
  z.null(),
  z.record(z.string(), z.never()),
]);

export const B3PropagatorSchema = z.union([
  z.null(),
  z.record(z.string(), z.never()),
]);

export const BaggagePropagatorSchema = z.union([
  z.null(),
  z.record(z.string(), z.never()),
]);

export const HttpTlsSchema = z.union([
  z.null(),
  z
    .object({
      ca_file: z
...
export const NameStringValuePairSchema = z
  .object({
    name: z
      .string()
      .describe(
...
export const OtlpHttpEncodingSchema = z.enum(['protobuf', 'json']);

export const OtlpHttpExporterSchema = z.union([
  z.null(),
  z
    .object({
      endpoint: z
      ...
      timeout: z
        ...
        .optional(),
      encoding: OtlpHttpEncodingSchema.describe(
...
export const GrpcTlsSchema = z.union([
  z.null(),
  z
    .object({
      ca_file: z
...
export const OtlpGrpcExporterSchema = z.union([
  z.null(),
  z
    .object({
      endpoint: z
...
export const ExperimentalOtlpFileExporterSchema = z.union([
  z.null(),
  z
    .object({
      output_stream: z
...
export const ConsoleExporterSchema = z.union([
  z.null(),
  z.record(z.string(), z.never()),
]);

export const LogRecordExporterSchema = z
  .object({
    otlp_http: OtlpHttpExporterSchema.describe(
      'Configure exporter to be OTLP with HTTP transport.\nIf omitted, ignore.\n'
    ).optional(),
    otlp_grpc: OtlpGrpcExporterSchema.describe(
      'Configure exporter to be OTLP with gRPC transport.\nIf omitted, ignore.\n'
    ).optional(),
    'otlp_file/development': ExperimentalOtlpFileExporterSchema.describe(
      'Configure exporter to be OTLP with file transport.\nIf omitted, ignore.\n'
    ).optional(),
    console: ConsoleExporterSchema.describe(
      'Configure exporter to be console.\nIf omitted, ignore.\n'
    ).optional(),
  })
  .catchall(z.union([z.null(), z.record(z.string(), z.any())]));

export const BatchLogRecordProcessorSchema = z
  .object({
    schedule_delay: z
      .union([
        z
    ...
    max_export_batch_size: z
      ...
      .optional(),
    exporter: LogRecordExporterSchema.describe(
      'Configure exporter.\nProperty is required and must be non-null.\n'
    ),
  })
  .strict();

export const SpanExporterSchema = z
  .object({
    otlp_http: OtlpHttpExporterSchema.describe(
      'Configure exporter to be OTLP with HTTP transport.\nIf omitted, ignore.\n'
    ).optional(),
...
export const BatchSpanProcessorSchema = z
  .object({
    schedule_delay: z
      .union([
        z
    ...
    max_export_batch_size: z
      ...
      .optional(),
    exporter: SpanExporterSchema.describe(
      'Configure exporter.\nProperty is required and must be non-null.\n'
    ),
  })
  .strict();

export const CardinalityLimitsSchema = z
  .object({
    default: z
      .union([
        z
...
export const ExporterTemporalityPreferenceSchema = z.enum([
  'cumulative',
  'delta',
  'low_memory',
]);

export const ExporterDefaultHistogramAggregationSchema = z.enum([
  'explicit_bucket_histogram',
  'base2_exponential_bucket_histogram',
]);

export const ConsoleMetricExporterSchema = z.union([
  z.null(),
  z
    .object({
      temporality_preference: ExporterTemporalityPreferenceSchema.describe(
      ...
      default_histogram_aggregation:
        ExporterDefaultHistogramAggregationSchema.describe(
...
export const ExemplarFilterSchema = z.enum([
  'always_on',
  'always_off',
  'trace_based',
]);

export const ExperimentalComposableAlwaysOffSamplerSchema = z.union([
  z.null(),
  z.record(z.string(), z.never()),
]);

export const ExperimentalComposableAlwaysOnSamplerSchema = z.union([
  z.null(),
  z.record(z.string(), z.never()),
]);

export const ExperimentalComposableProbabilitySamplerSchema = z.union([
  z.null(),
  z
    .object({
      ratio: z
...
export const ExperimentalComposableRuleBasedSamplerRuleAttributeValuesSchema = z
  .object({
    key: z
      .string()
      .describe(
...
export const ExperimentalComposableRuleBasedSamplerRuleAttributePatternsSchema =
  z
    .object({
      key: z
        .string()
...
export const ExperimentalSpanParentSchema = z.enum(['none', 'remote', 'local']);

_ExperimentalComposableRuleBasedSamplerRuleSchema = z
  .object({
    attribute_values:
      ExperimentalComposableRuleBasedSamplerRuleAttributeValuesSchema.describe(
    ...
    attribute_patterns:
      ExperimentalComposableRuleBasedSamplerRuleAttributePatternsSchema.describe(
    ...
    span_kinds: z
      ...
      .optional(),
    parent: z
      .array(ExperimentalSpanParentSchema)
      .describe(
      ...
      .optional(),
    sampler: ExperimentalComposableSamplerSchema.describe(
...
_ExperimentalComposableRuleBasedSamplerSchema = z.union([
  z.null(),
  z
    .object({
      rules: z
        .union([
          ...
          z
            .array(ExperimentalComposableRuleBasedSamplerRuleSchema)
            .describe(
              'The rules for the sampler, matched in order. If no rules match, the span is not sampled.\nIf omitted or null, no span is sampled.\n'
            ),
        ])
...
_ExperimentalComposableSamplerSchema = z
  .object({
    always_off: ExperimentalComposableAlwaysOffSamplerSchema.describe(
      'Configure sampler to be always_off.\nIf omitted, ignore.\n'
    ).optional(),
    always_on: ExperimentalComposableAlwaysOnSamplerSchema.describe(
      'Configure sampler to be always_on.\nIf omitted, ignore.\n'
    ).optional(),
    parent_threshold:
      ExperimentalComposableParentThresholdSamplerSchema.describe(
        'Configure sampler to be parent_threshold.\nIf omitted, ignore.\n'
      ).optional(),
    probability: ExperimentalComposableProbabilitySamplerSchema.describe(
      'Configure sampler to be probability.\nIf omitted, ignore.\n'
    ).optional(),
    rule_based: ExperimentalComposableRuleBasedSamplerSchema.describe(
      'Configure sampler to be rule_based.\nIf omitted, ignore.\n'
    ).optional(),
  })
  .catchall(z.union([z.null(), z.record(z.string(), z.any())]));

_ExperimentalComposableParentThresholdSamplerSchema = z
  .object({
    root: ExperimentalComposableSamplerSchema.describe(
      'Sampler to use when there is no parent.\nProperty is required and must be non-null.\n'
    ),
  })
  .strict();

export const ExperimentalContainerResourceDetectorSchema = z.union([
  z.null(),
  z.record(z.string(), z.never()),
]);

export const ExperimentalPeerServiceMappingSchema = z
  .object({
    peer: z
      .string()
      .describe(
...
export const ExperimentalPeerInstrumentationSchema = z
  .object({
    service_mapping: z
      .array(ExperimentalPeerServiceMappingSchema)
      .describe(
...
export const ExperimentalHttpClientInstrumentationSchema = z
  .object({
    request_captured_headers: z
      .array(z.string())
      .min(1)
      .describe(
...
export const ExperimentalHttpServerInstrumentationSchema = z
  .object({
    request_captured_headers: z
      .array(z.string())
      .min(1)
...
export const ExperimentalHttpInstrumentationSchema = z
  .object({
    client: ExperimentalHttpClientInstrumentationSchema.describe(
    ...
    server: ExperimentalHttpServerInstrumentationSchema.describe(
...
export const ExperimentalGeneralInstrumentationSchema = z
  .object({
    peer: ExperimentalPeerInstrumentationSchema.describe(
    ...
    http: ExperimentalHttpInstrumentationSchema.describe(
...
export const ExperimentalHostResourceDetectorSchema = z.union([
  z.null(),
  z.record(z.string(), z.never()),
]);

export const ExperimentalLanguageSpecificInstrumentationSchema = z.record(
  z.string(),
  z.record(z.string(), z.any())
);

export const ExperimentalInstrumentationSchema = z
  .object({
    general: ExperimentalGeneralInstrumentationSchema.describe(
    ...
    cpp: ExperimentalLanguageSpecificInstrumentationSchema.describe(
      'Configure C++ language-specific instrumentation libraries.\nIf omitted, instrumentation defaults are used.\n'
    ).optional(),
    dotnet: ExperimentalLanguageSpecificInstrumentationSchema.describe(
    ...
    erlang: ExperimentalLanguageSpecificInstrumentationSchema.describe(
      "Configure Erlang language-specific instrumentation libraries.\nEach entry's key identifies a particular instrumentation library. The corresponding value configures it.\nIf omitted, instrumentation defaults are used.\n"
    ).optional(),
    go: ExperimentalLanguageSpecificInstrumentationSchema.describe(
      "Configure Go language-specific instrumentation libraries.\nEach entry's key identifies a particular instrumentation library. The corresponding value configures it.\nIf omitted, instrumentation defaults are used.\n"
    ).optional(),
    java: ExperimentalLanguageSpecificInstrumentationSchema.describe(
      "Configure Java language-specific instrumentation libraries.\nEach entry's key identifies a particular instrumentation library. The corresponding value configures it.\nIf omitted, instrumentation defaults are used.\n"
    ).optional(),
    js: ExperimentalLanguageSpecificInstrumentationSchema.describe(
      "Configure JavaScript language-specific instrumentation libraries.\nEach entry's key identifies a particular instrumentation library. The corresponding value configures it.\nIf omitted, instrumentation defaults are used.\n"
    ).optional(),
    php: ExperimentalLanguageSpecificInstrumentationSchema.describe(
      "Configure PHP language-specific instrumentation libraries.\nEach entry's key identifies a particular instrumentation library. The corresponding value configures it.\nIf omitted, instrumentation defaults are used.\n"
    ).optional(),
    python: ExperimentalLanguageSpecificInstrumentationSchema.describe(
      "Configure Python language-specific instrumentation libraries.\nEach entry's key identifies a particular instrumentation library. The corresponding value configures it.\nIf omitted, instrumentation defaults are used.\n"
    ).optional(),
    ruby: ExperimentalLanguageSpecificInstrumentationSchema.describe(
      "Configure Ruby language-specific instrumentation libraries.\nEach entry's key identifies a particular instrumentation library. The corresponding value configures it.\nIf omitted, instrumentation defaults are used.\n"
    ).optional(),
    rust: ExperimentalLanguageSpecificInstrumentationSchema.describe(
      "Configure Rust language-specific instrumentation libraries.\nEach entry's key identifies a particular instrumentation library. The corresponding value configures it.\nIf omitted, instrumentation defaults are used.\n"
    ).optional(),
    swift: ExperimentalLanguageSpecificInstrumentationSchema.describe(
      "Configure Swift language-specific instrumentation libraries.\nEach entry's key identifies a particular instrumentation library. The corresponding value configures it.\nIf omitted, instrumentation defaults are used.\n"
    ).optional(),
  })
  .strict();

export const ExperimentalProbabilitySamplerSchema = z.union([
  z.null(),
  z
    .object({
      ratio: z
...
export const TraceIdRatioBasedSamplerSchema = z.union([
  z.null(),
  z
    .object({
      ratio: z
...
_ParentBasedSamplerSchema = z.union([
  z.null(),
  z
    .object({
      root: SamplerSchema.describe(
        'Configure root sampler.\nIf omitted, always_on is used.\n'
      ).optional(),
      remote_parent_sampled: SamplerSchema.describe(
        'Configure remote_parent_sampled sampler.\nIf omitted, always_on is used.\n'
      ).optional(),
      remote_parent_not_sampled: SamplerSchema.describe(
        'Configure remote_parent_not_sampled sampler.\nIf omitted, always_off is used.\n'
      ).optional(),
      local_parent_sampled: SamplerSchema.describe(
        'Configure local_parent_sampled sampler.\nIf omitted, always_on is used.\n'
      ).optional(),
      local_parent_not_sampled: SamplerSchema.describe(
...
_SamplerSchema = z
  .object({
    always_off: AlwaysOffSamplerSchema.describe(
      'Configure sampler to be always_off.\nIf omitted, ignore.\n'
    ).optional(),
    always_on: AlwaysOnSamplerSchema.describe(
      'Configure sampler to be always_on.\nIf omitted, ignore.\n'
    ).optional(),
    'composite/development': ExperimentalComposableSamplerSchema.describe(
      'Configure sampler to be composite.\nIf omitted, ignore.\n'
    ).optional(),
    'jaeger_remote/development': ExperimentalJaegerRemoteSamplerSchema.describe(
      'Configure sampler to be jaeger_remote.\nIf omitted, ignore.\n'
    ).optional(),
    parent_based: ParentBasedSamplerSchema.describe(
      'Configure sampler to be parent_based.\nIf omitted, ignore.\n'
    ).optional(),
    'probability/development': ExperimentalProbabilitySamplerSchema.describe(
      'Configure sampler to be probability.\nIf omitted, ignore.\n'
    ).optional(),
    trace_id_ratio_based: TraceIdRatioBasedSamplerSchema.describe(
      'Configure sampler to be trace_id_ratio_based.\nIf omitted, ignore.\n'
    ).optional(),
  })
  .catchall(z.union([z.null(), z.record(z.string(), z.any())]));

_ExperimentalJaegerRemoteSamplerSchema = z.union([
  z.null(),
  z
    .object({
      endpoint: z
      ...
      interval: z
        ...
        .optional(),
      initial_sampler: SamplerSchema.describe(
...
export const SeverityNumberSchema = z.enum([
  'trace',
  'trace2',
  'trace3',
  'trace4',
...
export const ExperimentalLoggerConfigSchema = z
  .object({
    disabled: z
      .union([
        z
      ...
      .optional(),
    minimum_severity: SeverityNumberSchema.describe(
...
export const ExperimentalLoggerMatcherAndConfigSchema = z
  .object({
    name: z
      .string()
      .describe(
    ...
    config: ExperimentalLoggerConfigSchema.describe(
      'The logger config.\nProperty is required and must be non-null.\n'
    ),
  })
  .strict();

export const ExperimentalLoggerConfiguratorSchema = z
  .object({
    default_config: ExperimentalLoggerConfigSchema.describe(
    ...
    loggers: z
      .array(ExperimentalLoggerMatcherAndConfigSchema)
      .describe(
...
export const ExperimentalMeterConfigSchema = z
  .object({
    disabled: z
      .boolean()
      .describe(
...
export const ExperimentalMeterMatcherAndConfigSchema = z
  .object({
    name: z
      .string()
      .describe(
    ...
    config: ExperimentalMeterConfigSchema.describe(
      'The meter config.\nProperty is required and must be non-null.\n'
    ),
  })
  .strict();

export const ExperimentalMeterConfiguratorSchema = z
  .object({
    default_config: ExperimentalMeterConfigSchema.describe(
    ...
    meters: z
      .array(ExperimentalMeterMatcherAndConfigSchema)
      .describe(
...
export const ExperimentalOtlpFileMetricExporterSchema = z.union([
  z.null(),
  z
    .object({
      output_stream: z
...
export const ExperimentalProcessResourceDetectorSchema = z.union([
  z.null(),
  z.record(z.string(), z.never()),
]);

export const IncludeExcludeSchema = z
  .object({
    included: z
      .array(z.string())
      .min(1)
...
export const ExperimentalPrometheusTranslationStrategySchema = z.enum([
...
export const ExperimentalPrometheusMetricExporterSchema = z.union([
  z.null(),
  z
    .object({
      host: z
      ...
      without_target_info: z
        ...
        .optional(),
      with_resource_constant_labels: IncludeExcludeSchema.describe(
      ...
      translation_strategy:
        ExperimentalPrometheusTranslationStrategySchema.describe(
...
export const ExperimentalServiceResourceDetectorSchema = z.union([
  z.null(),
  z.record(z.string(), z.never()),
]);

export const ExperimentalResourceDetectorSchema = z
  .object({
    container: ExperimentalContainerResourceDetectorSchema.describe(
      'Enable the container resource detector, which populates container.* attributes.\nIf omitted, ignore.\n'
    ).optional(),
    host: ExperimentalHostResourceDetectorSchema.describe(
      'Enable the host resource detector, which populates host.* and os.* attributes.\nIf omitted, ignore.\n'
    ).optional(),
    process: ExperimentalProcessResourceDetectorSchema.describe(
      'Enable the process resource detector, which populates process.* attributes.\nIf omitted, ignore.\n'
    ).optional(),
    service: ExperimentalServiceResourceDetectorSchema.describe(
...
export const ExperimentalResourceDetectionSchema = z
  .object({
    attributes: IncludeExcludeSchema.describe(
      'Configure attributes provided by resource detectors.\nIf omitted, all attributes from resource detectors are added.\n'
    ).optional(),
    detectors: z
      .array(ExperimentalResourceDetectorSchema)
      .describe(
...
export const ExperimentalTracerConfigSchema = z
  .object({
    disabled: z
      .boolean()
      .describe(
...
export const ExperimentalTracerMatcherAndConfigSchema = z
  .object({
    name: z
      .string()
      .describe(
    ...
    config: ExperimentalTracerConfigSchema.describe(
      'The tracer config.\nProperty is required and must be non-null.\n'
    ),
  })
  .strict();

export const ExperimentalTracerConfiguratorSchema = z
  .object({
    default_config: ExperimentalTracerConfigSchema.describe(
    ...
    tracers: z
      .array(ExperimentalTracerMatcherAndConfigSchema)
      .describe(
...
export const JaegerPropagatorSchema = z.union([
  z.null(),
  z.record(z.string(), z.never()),
]);

export const SimpleLogRecordProcessorSchema = z
  .object({
    exporter: LogRecordExporterSchema.describe(
      'Configure exporter.\nProperty is required and must be non-null.\n'
    ),
...
export const LogRecordProcessorSchema = z
  .object({
    batch: BatchLogRecordProcessorSchema.describe(
      'Configure a batch log record processor.\nIf omitted, ignore.\n'
    ).optional(),
    simple: SimpleLogRecordProcessorSchema.describe(
      'Configure a simple log record processor.\nIf omitted, ignore.\n'
    ).optional(),
  })
  .catchall(z.union([z.null(), z.record(z.string(), z.any())]));

export const LogRecordLimitsSchema = z
  .object({
    attribute_value_length_limit: z
      .union([
        z
...
export const LoggerProviderSchema = z
  .object({
    processors: z
      .array(LogRecordProcessorSchema)
      .describe(
        'Configure log record processors.\nProperty is required and must be non-null.\n'
      ),
    limits: LogRecordLimitsSchema.describe(
      'Configure log record limits. See also attribute_limits.\nIf omitted, default values as described in LogRecordLimits are used.\n'
    ).optional(),
    'logger_configurator/development':
      ExperimentalLoggerConfiguratorSchema.describe(
        'Configure loggers.\nIf omitted, all loggers use default values as described in ExperimentalLoggerConfig.\n'
      ).optional(),
  })
  .strict();

export const OtlpHttpMetricExporterSchema = z.union([
  z.null(),
  z
    .object({
      endpoint: z
...
export const OtlpGrpcMetricExporterSchema = z.union([
  z.null(),
  z
    .object({
      endpoint: z
...
export const PushMetricExporterSchema = z
  .object({
    otlp_http: OtlpHttpMetricExporterSchema.describe(
      'Configure exporter to be OTLP with HTTP transport.\nIf omitted, ignore.\n'
    ).optional(),
    otlp_grpc: OtlpGrpcMetricExporterSchema.describe(
      'Configure exporter to be OTLP with gRPC transport.\nIf omitted, ignore.\n'
    ).optional(),
    'otlp_file/development': ExperimentalOtlpFileMetricExporterSchema.describe(
      'Configure exporter to be OTLP with file transport.\nIf omitted, ignore.\n'
    ).optional(),
    console: ConsoleMetricExporterSchema.describe(
      'Configure exporter to be console.\nIf omitted, ignore.\n'
    ).optional(),
  })
  .catchall(z.union([z.null(), z.record(z.string(), z.any())]));

export const OpenCensusMetricProducerSchema = z.union([
  z.null(),
  z.record(z.string(), z.never()),
]);

export const MetricProducerSchema = z
  .object({
    opencensus: OpenCensusMetricProducerSchema.describe(
      'Configure metric producer to be opencensus.\nIf omitted, ignore.\n'
    ).optional(),
  })
  .catchall(z.union([z.null(), z.record(z.string(), z.any())]));

export const PeriodicMetricReaderSchema = z
  .object({
    interval: z
      .union([
        z
    ...
    timeout: z
      ...
      .optional(),
    exporter: PushMetricExporterSchema.describe(
      'Configure exporter.\nProperty is required and must be non-null.\n'
    ),
    producers: z
      .array(MetricProducerSchema)
      .describe(
        'Configure metric producers.\nIf omitted, no metric producers are added.\n'
      )
      .optional(),
    cardinality_limits: CardinalityLimitsSchema.describe(
      'Configure cardinality limits.\nIf omitted, default values as described in CardinalityLimits are used.\n'
    ).optional(),
  })
  .strict();

export const PullMetricExporterSchema = z
  .object({
    'prometheus/development':
      ExperimentalPrometheusMetricExporterSchema.describe(
        'Configure exporter to be prometheus.\nIf omitted, ignore.\n'
      ).optional(),
  })
  .catchall(z.union([z.null(), z.record(z.string(), z.any())]));

export const PullMetricReaderSchema = z
  .object({
    exporter: PullMetricExporterSchema.describe(
      'Configure exporter.\nProperty is required and must be non-null.\n'
    ),
    producers: z
      .array(MetricProducerSchema)
...
export const MetricReaderSchema = z
  .object({
    periodic: PeriodicMetricReaderSchema.describe(
      'Configure a periodic metric reader.\nIf omitted, ignore.\n'
    ).optional(),
    pull: PullMetricReaderSchema.describe(
      'Configure a pull based metric reader.\nIf omitted, ignore.\n'
    ).optional(),
  })
  .strict();

export const ViewSelectorSchema = z
  .object({
    instrument_name: z
      .union([
        z
      ...
      .optional(),
    instrument_type: InstrumentTypeSchema.describe(
...
export const ViewStreamSchema = z
  .object({
    name: z
      .union([
        z
    ...
    aggregation_cardinality_limit: z
      .union([
        z
          .null()
          .describe(
      ...
      .optional(),
    attribute_keys: IncludeExcludeSchema.describe(
...
export const ViewSchema = z
  .object({
    selector: ViewSelectorSchema.describe(
    ...
    stream: ViewStreamSchema.describe(
      'Configure view stream.\nProperty is required and must be non-null.\n'
    ),
  })
  .strict();

export const MeterProviderSchema = z
  .object({
    readers: z
      .array(MetricReaderSchema)
      .describe(
    ...
    views: z
      ...
      .optional(),
    exemplar_filter: ExemplarFilterSchema.describe(
    ...
    'meter_configurator/development':
      ExperimentalMeterConfiguratorSchema.describe(
        'Configure meters.\nIf omitted, all meters use default values as described in ExperimentalMeterConfig.\n'
      ).optional(),
  })
  .strict();

export const OpenTracingPropagatorSchema = z.union([
  z.null(),
  z.record(z.string(), z.never()),
]);

export const TraceContextPropagatorSchema = z.union([
  z.null(),
  z.record(z.string(), z.never()),
]);

export const TextMapPropagatorSchema = z
  .object({
    tracecontext: TraceContextPropagatorSchema.describe(
      'Include the w3c trace context propagator.\nIf omitted, ignore.\n'
    ).optional(),
    baggage: BaggagePropagatorSchema.describe(
      'Include the w3c baggage propagator.\nIf omitted, ignore.\n'
    ).optional(),
    b3: B3PropagatorSchema.describe(
      'Include the zipkin b3 propagator.\nIf omitted, ignore.\n'
    ).optional(),
    b3multi: B3MultiPropagatorSchema.describe(
      'Include the zipkin b3 multi propagator.\nIf omitted, ignore.\n'
    ).optional(),
    jaeger: JaegerPropagatorSchema.describe(
      'Include the jaeger propagator.\nIf omitted, ignore.\n'
    ).optional(),
    ottrace: OpenTracingPropagatorSchema.describe(
      'Include the opentracing propagator.\nIf omitted, ignore.\n'
    ).optional(),
  })
  .catchall(z.union([z.null(), z.record(z.string(), z.any())]));

export const PropagatorSchema = z
  .object({
    composite: z
      .array(TextMapPropagatorSchema)
      .describe(
...
export const ResourceSchema = z
  .object({
    attributes: z
      .array(AttributeNameValueSchema)
      .describe(
        'Configure resource attributes. Entries have higher priority than entries from .resource.attributes_list.\nIf omitted, no resource attributes are added.\n'
      )
      .optional(),
    'detection/development': ExperimentalResourceDetectionSchema.describe(
...
export const SimpleSpanProcessorSchema = z
  .object({
    exporter: SpanExporterSchema.describe(
      'Configure exporter.\nProperty is required and must be non-null.\n'
    ),
...
export const SpanLimitsSchema = z
  .object({
    attribute_value_length_limit: z
      .union([
        z
...
export const SpanProcessorSchema = z
  .object({
    batch: BatchSpanProcessorSchema.describe(
      'Configure a batch span processor.\nIf omitted, ignore.\n'
    ).optional(),
    simple: SimpleSpanProcessorSchema.describe(
      'Configure a simple span processor.\nIf omitted, ignore.\n'
    ).optional(),
  })
  .catchall(z.union([z.null(), z.record(z.string(), z.any())]));

export const TracerProviderSchema = z
  .object({
    processors: z
      .array(SpanProcessorSchema)
      .describe(
        'Configure span processors.\nProperty is required and must be non-null.\n'
      ),
    limits: SpanLimitsSchema.describe(
      'Configure span limits. See also attribute_limits.\nIf omitted, default values as described in SpanLimits are used.\n'
    ).optional(),
    sampler: SamplerSchema.describe(
      'Configure the sampler.\nIf omitted, parent based sampler with a root of always_on is used.\n'
    ).optional(),
    'tracer_configurator/development':
      ExperimentalTracerConfiguratorSchema.describe(
...
export const OpenTelemetryConfigurationSchema: z.ZodTypeAny = z
  .object({
    file_format: z
      .string()
      .describe(
    ...
    disabled: z
      ...
      .optional(),
    log_level: SeverityNumberSchema.describe(
      'Configure the log level of the internal logger used by the SDK.\nValues include:\n* debug: debug, severity number 5.\n* debug2: debug2, severity number 6.\n* debug3: debug3, severity number 7.\n* debug4: debug4, severity number 8.\n* error: error, severity number 17.\n* error2: error2, severity number 18.\n* error3: error3, severity number 19.\n* error4: error4, severity number 20.\n* fatal: fatal, severity number 21.\n* fatal2: fatal2, severity number 22.\n* fatal3: fatal3, severity number 23.\n* fatal4: fatal4, severity number 24.\n* info: info, severity number 9.\n* info2: info2, severity number 10.\n* info3: info3, severity number 11.\n* info4: info4, severity number 12.\n* trace: trace, severity number 1.\n* trace2: trace2, severity number 2.\n* trace3: trace3, severity number 3.\n* trace4: trace4, severity number 4.\n* warn: warn, severity number 13.\n* warn2: warn2, severity number 14.\n* warn3: warn3, severity number 15.\n* warn4: warn4, severity number 16.\nIf omitted, INFO is used.\n'
    ).optional(),
    attribute_limits: AttributeLimitsSchema.describe(
      'Configure general attribute limits. See also tracer_provider.limits, logger_provider.limits.\nIf omitted, default values as described in AttributeLimits are used.\n'
    ).optional(),
    logger_provider: LoggerProviderSchema.describe(
      'Configure logger provider.\nIf omitted, a noop logger provider is used.\n'
    ).optional(),
    meter_provider: MeterProviderSchema.describe(
      'Configure meter provider.\nIf omitted, a noop meter provider is used.\n'
    ).optional(),
    propagator: PropagatorSchema.describe(
      'Configure text map context propagators.\nIf omitted, a noop propagator is used.\n'
    ).optional(),
    tracer_provider: TracerProviderSchema.describe(
      'Configure tracer provider.\nIf omitted, a noop tracer provider is used.\n'
    ).optional(),
    resource: ResourceSchema.describe(
      'Configure resource for all signals.\nIf omitted, the default resource is used.\n'
    ).optional(),
    'instrumentation/development': ExperimentalInstrumentationSchema.describe(
