...
const setup = () => {
  ...
  const multiLogRecordProcessor = new MultiLogRecordProcessor(forceFlushTimeoutMillis);
...
describe("MultiLogRecordProcessor", () => {
  describe("constructor", () => {
    it("should contruct an instance", () => {
      assert.ok(setup().multiLogRecordProcessor instanceof MultiLogRecordProcessor);
    });
  });
  ...
  describe("forceFlush", () => {
    ...
    it("should throw error if either time out", async () => {
      ...
      multiLogRecordProcessor.addLogRecordProcessor(logRecordProcessorWithTimeout);
      multiLogRecordProcessor.addLogRecordProcessor(logRecordProcessor);
