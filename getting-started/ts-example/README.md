...
This TypeScript guide will walk you through the setup and configuration process for a tracing backend (in this case [Zipkin](https://zipkin.io), but [Jaeger](https://www.jaegertracing.io) would be simple to use as well), a metrics backend like [Prometheus](https://prometheus.io), and auto-instrumentation of NodeJS.
...
## Tracing Your Application with OpenTelemetry ([link to JS version](../README.md#tracing-your-application-with-opentelemetry))
...
### Setting up a Tracing Backend ([link to JS version](../README.md#setting-up-a-tracing-backend))
...
### Trace Your NodeJS Application ([link to JS version](../README.md#trace-your-nodejs-application))
...
#### Install the required OpenTelemetry libraries ([link to JS version](../README.md#install-the-required-opentelemetry-libraries))
...
#### Initialize a global tracer ([link to JS version](../README.md#initialize-a-global-tracer))
...
#### Initialize and Register a Trace Exporter ([link to JS version](../README.md#initialize-and-register-a-trace-exporter))
...
## Collect Metrics Using OpenTelemetry ([link to JS version](../README.md#collect-metrics-using-opentelemetry))
...
### Set up a Metrics Backend ([link to JS version](../README.md#set-up-a-metrics-backend))
...
### Monitor Your NodeJS Application ([link to JS version](../README.md#monitor-your-nodejs-application))
...
#### Install the required OpenTelemetry metrics libraries ([link to JS version](../README.md#install-the-required-opentelemetry-metrics-libraries))
...
#### Initialize a meter and collect metrics ([link to JS version](../README.md#initialize-a-meter-and-collect-metrics))
...
#### Initialize and register a metrics exporter ([link to JS version](../README.md#initialize-and-register-a-metrics-exporter))
