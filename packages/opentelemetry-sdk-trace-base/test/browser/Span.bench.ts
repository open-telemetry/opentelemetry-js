...
describe('Span benchmark (browser)', function () {
  it('create spans (10 attributes) (browser)', async () => {
  ...
  it('create spans (10 attributes w/ setAttributes) (browser)', async () => {
    await new Promise<void>(resolve => {
      const suite = new Benchmark.Suite();
      suite
  ...
  it('addEvent / addLink (128 attributes, at default per-event/link limit) (browser)', async () => {
    await new Promise<void>(resolve => {
      const suite = new Benchmark.Suite();
      suite
