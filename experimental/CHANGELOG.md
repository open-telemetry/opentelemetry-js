...
* fix(instrumentation-http): Ensure instrumentation of `http.get` and `https.request` work when used in ESM code [#4857](https://github.com/open-telemetry/opentelemetry-js/issues/4857) @trentm
