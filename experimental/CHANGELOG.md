...
* feat(opentelemetry-configuration): add backup options for certificates and endpoints [#xx](https://github.com/open-telemetry/opentelemetry-js/pull/xx) @maryliag
