...
// Note: Unlike `@opentelemetry/semantic-conventions`, these measure the
// "incubating" entry-point. Every GenAI convention is currently in development,
// so the main entry-point exports nothing to measure.
const entryPoints = [
  {
    name: 'cjs',
    entry: './build/src/index-incubating.js',
  },
  {
    name: 'esm',
    entry: './build/esm/index-incubating.js',
  },
  {
    name: 'esnext',
    entry: './build/esnext/index-incubating.js',
  },
];
