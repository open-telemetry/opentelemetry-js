...
export const DbSystemValues: DbSystemValues = {
  OTHER_SQL: TMP_DBSYSTEMVALUES_OTHER_SQL,
  MSSQL: TMP_DBSYSTEMVALUES_MSSQL,
  MYSQL: TMP_DBSYSTEMVALUES_MYSQL,
  ORACLE: TMP_DBSYSTEMVALUES_ORACLE,
  DB2: TMP_DBSYSTEMVALUES_DB2,
  POSTGRESQL: TMP_DBSYSTEMVALUES_POSTGRESQL,
  REDSHIFT: TMP_DBSYSTEMVALUES_REDSHIFT,
  HIVE: TMP_DBSYSTEMVALUES_HIVE,
  CLOUDSCAPE: TMP_DBSYSTEMVALUES_CLOUDSCAPE,
  HSQLDB: TMP_DBSYSTEMVALUES_HSQLDB,
  PROGRESS: TMP_DBSYSTEMVALUES_PROGRESS,
  MAXDB: TMP_DBSYSTEMVALUES_MAXDB,
  HANADB: TMP_DBSYSTEMVALUES_HANADB,
  INGRES: TMP_DBSYSTEMVALUES_INGRES,
  FIRSTSQL: TMP_DBSYSTEMVALUES_FIRSTSQL,
  EDB: TMP_DBSYSTEMVALUES_EDB,
  CACHE: TMP_DBSYSTEMVALUES_CACHE,
  ADABAS: TMP_DBSYSTEMVALUES_ADABAS,
  FIREBIRD: TMP_DBSYSTEMVALUES_FIREBIRD,
  DERBY: TMP_DBSYSTEMVALUES_DERBY,
  FILEMAKER: TMP_DBSYSTEMVALUES_FILEMAKER,
  INFORMIX: TMP_DBSYSTEMVALUES_INFORMIX,
  INSTANTDB: TMP_DBSYSTEMVALUES_INSTANTDB,
  INTERBASE: TMP_DBSYSTEMVALUES_INTERBASE,
  MARIADB: TMP_DBSYSTEMVALUES_MARIADB,
  NETEZZA: TMP_DBSYSTEMVALUES_NETEZZA,
  PERVASIVE: TMP_DBSYSTEMVALUES_PERVASIVE,
  POINTBASE: TMP_DBSYSTEMVALUES_POINTBASE,
  SQLITE: TMP_DBSYSTEMVALUES_SQLITE,
  SYBASE: TMP_DBSYSTEMVALUES_SYBASE,
  TERADATA: TMP_DBSYSTEMVALUES_TERADATA,
  VERTICA: TMP_DBSYSTEMVALUES_VERTICA,
  H2: TMP_DBSYSTEMVALUES_H2,
  COLDFUSION: TMP_DBSYSTEMVALUES_COLDFUSION,
  CASSANDRA: TMP_DBSYSTEMVALUES_CASSANDRA,
  HBASE: TMP_DBSYSTEMVALUES_HBASE,
  MONGODB: TMP_DBSYSTEMVALUES_MONGODB,
  REDIS: TMP_DBSYSTEMVALUES_REDIS,
  COUCHBASE: TMP_DBSYSTEMVALUES_COUCHBASE,
  COUCHDB: TMP_DBSYSTEMVALUES_COUCHDB,
  COSMOSDB: TMP_DBSYSTEMVALUES_COSMOSDB,
  DYNAMODB: TMP_DBSYSTEMVALUES_DYNAMODB,
  NEO4J: TMP_DBSYSTEMVALUES_NEO4J,
  GEODE: TMP_DBSYSTEMVALUES_GEODE,
  ELASTICSEARCH: TMP_DBSYSTEMVALUES_ELASTICSEARCH,
  MEMCACHED: TMP_DBSYSTEMVALUES_MEMCACHED,
  COCKROACHDB: TMP_DBSYSTEMVALUES_COCKROACHDB,
};
...
export const DbCassandraConsistencyLevelValues: DbCassandraConsistencyLevelValues =
  {
    ALL: TMP_DBCASSANDRACONSISTENCYLEVELVALUES_ALL,
    EACH_QUORUM: TMP_DBCASSANDRACONSISTENCYLEVELVALUES_EACH_QUORUM,
    QUORUM: TMP_DBCASSANDRACONSISTENCYLEVELVALUES_QUORUM,
    LOCAL_QUORUM: TMP_DBCASSANDRACONSISTENCYLEVELVALUES_LOCAL_QUORUM,
    ONE: TMP_DBCASSANDRACONSISTENCYLEVELVALUES_ONE,
    TWO: TMP_DBCASSANDRACONSISTENCYLEVELVALUES_TWO,
    THREE: TMP_DBCASSANDRACONSISTENCYLEVELVALUES_THREE,
    LOCAL_ONE: TMP_DBCASSANDRACONSISTENCYLEVELVALUES_LOCAL_ONE,
    ANY: TMP_DBCASSANDRACONSISTENCYLEVELVALUES_ANY,
    SERIAL: TMP_DBCASSANDRACONSISTENCYLEVELVALUES_SERIAL,
    LOCAL_SERIAL: TMP_DBCASSANDRACONSISTENCYLEVELVALUES_LOCAL_SERIAL,
  };
...
export const FaasTriggerValues: FaasTriggerValues = {
  DATASOURCE: TMP_FAASTRIGGERVALUES_DATASOURCE,
  HTTP: TMP_FAASTRIGGERVALUES_HTTP,
  PUBSUB: TMP_FAASTRIGGERVALUES_PUBSUB,
  TIMER: TMP_FAASTRIGGERVALUES_TIMER,
  OTHER: TMP_FAASTRIGGERVALUES_OTHER,
};
...
export const FaasDocumentOperationValues: FaasDocumentOperationValues = {
  INSERT: TMP_FAASDOCUMENTOPERATIONVALUES_INSERT,
  EDIT: TMP_FAASDOCUMENTOPERATIONVALUES_EDIT,
  DELETE: TMP_FAASDOCUMENTOPERATIONVALUES_DELETE,
};
...
export const FaasInvokedProviderValues: FaasInvokedProviderValues = {
  ...
  AWS: TMP_FAASINVOKEDPROVIDERVALUES_AWS,
  AZURE: TMP_FAASINVOKEDPROVIDERVALUES_AZURE,
  GCP: TMP_FAASINVOKEDPROVIDERVALUES_GCP,
};
...
export const NetTransportValues: NetTransportValues = {
  IP_TCP: TMP_NETTRANSPORTVALUES_IP_TCP,
  IP_UDP: TMP_NETTRANSPORTVALUES_IP_UDP,
  IP: TMP_NETTRANSPORTVALUES_IP,
  UNIX: TMP_NETTRANSPORTVALUES_UNIX,
  PIPE: TMP_NETTRANSPORTVALUES_PIPE,
  INPROC: TMP_NETTRANSPORTVALUES_INPROC,
  OTHER: TMP_NETTRANSPORTVALUES_OTHER,
};
...
export const NetHostConnectionTypeValues: NetHostConnectionTypeValues = {
  WIFI: TMP_NETHOSTCONNECTIONTYPEVALUES_WIFI,
  WIRED: TMP_NETHOSTCONNECTIONTYPEVALUES_WIRED,
  CELL: TMP_NETHOSTCONNECTIONTYPEVALUES_CELL,
  UNAVAILABLE: TMP_NETHOSTCONNECTIONTYPEVALUES_UNAVAILABLE,
  UNKNOWN: TMP_NETHOSTCONNECTIONTYPEVALUES_UNKNOWN,
};
...
export const NetHostConnectionSubtypeValues: NetHostConnectionSubtypeValues = {
  GPRS: TMP_NETHOSTCONNECTIONSUBTYPEVALUES_GPRS,
  EDGE: TMP_NETHOSTCONNECTIONSUBTYPEVALUES_EDGE,
  UMTS: TMP_NETHOSTCONNECTIONSUBTYPEVALUES_UMTS,
  CDMA: TMP_NETHOSTCONNECTIONSUBTYPEVALUES_CDMA,
  EVDO_0: TMP_NETHOSTCONNECTIONSUBTYPEVALUES_EVDO_0,
  EVDO_A: TMP_NETHOSTCONNECTIONSUBTYPEVALUES_EVDO_A,
  CDMA2000_1XRTT: TMP_NETHOSTCONNECTIONSUBTYPEVALUES_CDMA2000_1XRTT,
  HSDPA: TMP_NETHOSTCONNECTIONSUBTYPEVALUES_HSDPA,
  HSUPA: TMP_NETHOSTCONNECTIONSUBTYPEVALUES_HSUPA,
  HSPA: TMP_NETHOSTCONNECTIONSUBTYPEVALUES_HSPA,
  IDEN: TMP_NETHOSTCONNECTIONSUBTYPEVALUES_IDEN,
  EVDO_B: TMP_NETHOSTCONNECTIONSUBTYPEVALUES_EVDO_B,
  LTE: TMP_NETHOSTCONNECTIONSUBTYPEVALUES_LTE,
  EHRPD: TMP_NETHOSTCONNECTIONSUBTYPEVALUES_EHRPD,
  HSPAP: TMP_NETHOSTCONNECTIONSUBTYPEVALUES_HSPAP,
  GSM: TMP_NETHOSTCONNECTIONSUBTYPEVALUES_GSM,
  TD_SCDMA: TMP_NETHOSTCONNECTIONSUBTYPEVALUES_TD_SCDMA,
  IWLAN: TMP_NETHOSTCONNECTIONSUBTYPEVALUES_IWLAN,
  NR: TMP_NETHOSTCONNECTIONSUBTYPEVALUES_NR,
  NRNSA: TMP_NETHOSTCONNECTIONSUBTYPEVALUES_NRNSA,
  LTE_CA: TMP_NETHOSTCONNECTIONSUBTYPEVALUES_LTE_CA,
};
...
export const MessagingDestinationKindValues: MessagingDestinationKindValues = {
  QUEUE: TMP_MESSAGINGDESTINATIONKINDVALUES_QUEUE,
  TOPIC: TMP_MESSAGINGDESTINATIONKINDVALUES_TOPIC,
};
...
export const MessagingOperationValues: MessagingOperationValues = {
  ...
  PROCESS: TMP_MESSAGINGOPERATIONVALUES_PROCESS,
};
...
export const MessageTypeValues: MessageTypeValues = {
  SENT: TMP_MESSAGETYPEVALUES_SENT,
  RECEIVED: TMP_MESSAGETYPEVALUES_RECEIVED,
};
