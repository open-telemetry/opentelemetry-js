...
describe('config', () => {
  ...
  describe('buildSamplerFromEnv()', () => {
    ...
    it('should handle always_off case', () => {
      process.env.OTEL_TRACE_SAMPLER = 'always_off';
    ...
    it('should handle traceidratio case', () => {
      process.env.OTEL_TRACE_SAMPLER = 'traceidratio';
      process.env.OTEL_TRACE_SAMPLER_ARG = '0.1';
    ...
    it('should handle parentbased_always_on case', () => {
      process.env.OTEL_TRACE_SAMPLER = 'parentbased_always_on';
    ...
    it('should handle parentbased_always_off case', () => {
      process.env.OTEL_TRACE_SAMPLER = 'parentbased_always_off';
      assert.ok(buildSamplerFromEnv() instanceof ParentBasedSampler);
      assert.strictEqual(
        buildSamplerFromEnv().toString(),
    ...
    it('should handle parentbased_traceidratio case', () => {
      process.env.OTEL_TRACE_SAMPLER = 'parentbased_traceidratio';
      process.env.OTEL_TRACE_SAMPLER_ARG = '0.2';
      assert.ok(buildSamplerFromEnv() instanceof ParentBasedSampler);
      assert.strictEqual(
        buildSamplerFromEnv().toString(),
