...
export class EnvironmentGetter implements TextMapGetter<unknown> {
  private readonly _carrier: EnvironmentCarrier = {};
 ...
 */
export class EnvironmentSetter implements TextMapSetter<EnvironmentCarrier> {
  set(carrier: EnvironmentCarrier, key: string, value: string): void {
