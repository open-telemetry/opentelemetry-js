...
* feat(configuration): auto-generate TypeScript types from OTel declarative config JSON schema using `json-schema-to-typescript` and `ajv` [#6533](https://github.com/open-telemetry/opentelemetry-js/pull/6533)
