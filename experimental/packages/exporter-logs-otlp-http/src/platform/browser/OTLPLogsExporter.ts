...
class OTLPExporterBrowserProxy extends OTLPExporterBrowserBase<
  ...
  IExportLogsServiceRequest
> {
  constructor(config?: OTLPLogsExporterOptions & OTLPExporterConfigBase) {
    super(config);
 ...
 */
export class OTLPLogsExporter extends OTLPLogsExporterBase<OTLPExporterBrowserProxy> {
  constructor(config?: OTLPExporterConfigBase & OTLPLogsExporterOptions) {
