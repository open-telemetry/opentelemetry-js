...
const TMP_MESSAGING_DESTINATION_PARTITION_ID = 'messaging.destination.partition.id';
...
const TMP_MESSAGING_EVENTHUBS_CONSUMER_GROUP = 'messaging.eventhubs.consumer.group';
const TMP_MESSAGING_EVENTHUBS_MESSAGE_ENQUEUED_TIME = 'messaging.eventhubs.message.enqueued_time';
...
const TMP_MESSAGING_RABBITMQ_MESSAGE_DELIVERY_TAG = 'messaging.rabbitmq.message.delivery_tag';
...
const TMP_MESSAGING_SERVICEBUS_DESTINATION_SUBSCRIPTION_NAME = 'messaging.servicebus.destination.subscription_name';
const TMP_MESSAGING_SERVICEBUS_DISPOSITION_STATUS = 'messaging.servicebus.disposition_status';
const TMP_MESSAGING_SERVICEBUS_MESSAGE_DELIVERY_COUNT = 'messaging.servicebus.message.delivery_count';
const TMP_MESSAGING_SERVICEBUS_MESSAGE_ENQUEUED_TIME = 'messaging.servicebus.message.enqueued_time';
...
*/
export const SEMATTRS_CONTAINER_IMAGE_REPO_DIGESTS = TMP_CONTAINER_IMAGE_REPO_DIGESTS;
...
*/
export const SEMATTRS_GCP_CLOUD_RUN_JOB_EXECUTION = TMP_GCP_CLOUD_RUN_JOB_EXECUTION;

/**
* The index for a task within an execution as provided by the [`CLOUD_RUN_TASK_INDEX`](https://cloud.google.com/run/docs/container-contract#jobs-env-vars) environment variable.
*/
export const SEMATTRS_GCP_CLOUD_RUN_JOB_TASK_INDEX = TMP_GCP_CLOUD_RUN_JOB_TASK_INDEX;
...
*/
export const SEMATTRS_K8S_CONTAINER_RESTART_COUNT = TMP_K8S_CONTAINER_RESTART_COUNT;
...
*/
export const SEMATTRS_MESSAGING_DESTINATION_PARTITION_ID = TMP_MESSAGING_DESTINATION_PARTITION_ID;
...
*/
export const SEMATTRS_MESSAGING_EVENTHUBS_CONSUMER_GROUP = TMP_MESSAGING_EVENTHUBS_CONSUMER_GROUP;

/**
* The UTC epoch seconds at which the message has been accepted and stored in the entity.
*/
export const SEMATTRS_MESSAGING_EVENTHUBS_MESSAGE_ENQUEUED_TIME = TMP_MESSAGING_EVENTHUBS_MESSAGE_ENQUEUED_TIME;
...
*/
export const SEMATTRS_MESSAGING_RABBITMQ_MESSAGE_DELIVERY_TAG = TMP_MESSAGING_RABBITMQ_MESSAGE_DELIVERY_TAG;
...
*/
export const SEMATTRS_MESSAGING_SERVICEBUS_DESTINATION_SUBSCRIPTION_NAME = TMP_MESSAGING_SERVICEBUS_DESTINATION_SUBSCRIPTION_NAME;

/**
* Describes the [settlement type](https://learn.microsoft.com/azure/service-bus-messaging/message-transfers-locks-settlement#peeklock).
*/
export const SEMATTRS_MESSAGING_SERVICEBUS_DISPOSITION_STATUS = TMP_MESSAGING_SERVICEBUS_DISPOSITION_STATUS;

/**
* Number of deliveries that have been attempted for this message.
*/
export const SEMATTRS_MESSAGING_SERVICEBUS_MESSAGE_DELIVERY_COUNT = TMP_MESSAGING_SERVICEBUS_MESSAGE_DELIVERY_COUNT;

/**
* The UTC epoch seconds at which the message has been accepted and stored in the entity.
*/
export const SEMATTRS_MESSAGING_SERVICEBUS_MESSAGE_ENQUEUED_TIME = TMP_MESSAGING_SERVICEBUS_MESSAGE_ENQUEUED_TIME;
...
*/
export const SEMATTRS_PROCESS_RUNTIME_DESCRIPTION = TMP_PROCESS_RUNTIME_DESCRIPTION;
 ...
 * @deprecated Use the PROCESSCPUSTATEVALUES_XXXXX constants rather than the ProcessCpuStateValues.XXXXX for bundle minification.
 */
export const ProcessCpuStateValues:ProcessCpuStateValues = /*#__PURE__*/createConstMap<ProcessCpuStateValues>([
 ...
 * The process state, e.g., [Linux Process State Codes](https://man7.org/linux/man-pages/man1/ps.1.html#PROCESS_STATE_CODES).
 */
export const SYSTEMPROCESSSTATUSVALUES_RUNNING = TMP_SYSTEMPROCESSSTATUSVALUES_RUNNING;

/**
 * The process state, e.g., [Linux Process State Codes](https://man7.org/linux/man-pages/man1/ps.1.html#PROCESS_STATE_CODES).
 */
export const SYSTEMPROCESSSTATUSVALUES_SLEEPING = TMP_SYSTEMPROCESSSTATUSVALUES_SLEEPING;

/**
 * The process state, e.g., [Linux Process State Codes](https://man7.org/linux/man-pages/man1/ps.1.html#PROCESS_STATE_CODES).
 */
export const SYSTEMPROCESSSTATUSVALUES_STOPPED = TMP_SYSTEMPROCESSSTATUSVALUES_STOPPED;

/**
 * The process state, e.g., [Linux Process State Codes](https://man7.org/linux/man-pages/man1/ps.1.html#PROCESS_STATE_CODES).
 */
export const SYSTEMPROCESSSTATUSVALUES_DEFUNCT = TMP_SYSTEMPROCESSSTATUSVALUES_DEFUNCT;
 ...
 * @deprecated Use the SYSTEMPROCESSSTATUSVALUES_XXXXX constants rather than the SystemProcessStatusValues.XXXXX for bundle minification.
 */
export const SystemProcessStatusValues:SystemProcessStatusValues = /*#__PURE__*/createConstMap<SystemProcessStatusValues>([
 ...
 * Note: The prefix of the service SHOULD match the one specified in `cloud.provider`.
 */
export const CLOUDPLATFORMVALUES_AZURE_CONTAINER_APPS = TMP_CLOUDPLATFORMVALUES_AZURE_CONTAINER_APPS;
 ...
 * The CPU state for this data point.
 */
export const CONTAINERCPUSTATEVALUES_SYSTEM = TMP_CONTAINERCPUSTATEVALUES_SYSTEM;

/**
 * The CPU state for this data point.
 */
export const CONTAINERCPUSTATEVALUES_KERNEL = TMP_CONTAINERCPUSTATEVALUES_KERNEL;
 ...
 * @deprecated Use the CONTAINERCPUSTATEVALUES_XXXXX constants rather than the ContainerCpuStateValues.XXXXX for bundle minification.
 */
export const ContainerCpuStateValues:ContainerCpuStateValues = /*#__PURE__*/createConstMap<ContainerCpuStateValues>([
 ...
 * Note: If a custom value is used, it MUST be of low cardinality.
 */
export const MESSAGINGOPERATIONVALUES_SETTLE = TMP_MESSAGINGOPERATIONVALUES_SETTLE;
...
const TMP_MESSAGINGSERVICEBUSDISPOSITIONSTATUSVALUES_DEAD_LETTER = 'dead_letter';
const TMP_MESSAGINGSERVICEBUSDISPOSITIONSTATUSVALUES_DEFER = 'defer';

/**
 * Describes the [settlement type](https://learn.microsoft.com/azure/service-bus-messaging/message-transfers-locks-settlement#peeklock).
 */
export const MESSAGINGSERVICEBUSDISPOSITIONSTATUSVALUES_COMPLETE = TMP_MESSAGINGSERVICEBUSDISPOSITIONSTATUSVALUES_COMPLETE;

/**
 * Describes the [settlement type](https://learn.microsoft.com/azure/service-bus-messaging/message-transfers-locks-settlement#peeklock).
 */
export const MESSAGINGSERVICEBUSDISPOSITIONSTATUSVALUES_ABANDON = TMP_MESSAGINGSERVICEBUSDISPOSITIONSTATUSVALUES_ABANDON;

/**
 * Describes the [settlement type](https://learn.microsoft.com/azure/service-bus-messaging/message-transfers-locks-settlement#peeklock).
 */
export const MESSAGINGSERVICEBUSDISPOSITIONSTATUSVALUES_DEAD_LETTER = TMP_MESSAGINGSERVICEBUSDISPOSITIONSTATUSVALUES_DEAD_LETTER;

/**
 * Describes the [settlement type](https://learn.microsoft.com/azure/service-bus-messaging/message-transfers-locks-settlement#peeklock).
 */
export const MESSAGINGSERVICEBUSDISPOSITIONSTATUSVALUES_DEFER = TMP_MESSAGINGSERVICEBUSDISPOSITIONSTATUSVALUES_DEFER;
 ...
 * @deprecated Use the MESSAGINGSERVICEBUSDISPOSITIONSTATUSVALUES_XXXXX constants rather than the MessagingServicebusDispositionStatusValues.XXXXX for bundle minification.
 */
export const MessagingServicebusDispositionStatusValues:MessagingServicebusDispositionStatusValues = /*#__PURE__*/createConstMap<MessagingServicebusDispositionStatusValues>([
 ...
 * An identifier for the messaging system being used. See below for a list of well-known identifiers.
 */
export const MESSAGINGSYSTEMVALUES_EVENTGRID = TMP_MESSAGINGSYSTEMVALUES_EVENTGRID;

/**
 * An identifier for the messaging system being used. See below for a list of well-known identifiers.
 */
export const MESSAGINGSYSTEMVALUES_EVENTHUBS = TMP_MESSAGINGSYSTEMVALUES_EVENTHUBS;

/**
 * An identifier for the messaging system being used. See below for a list of well-known identifiers.
 */
export const MESSAGINGSYSTEMVALUES_SERVICEBUS = TMP_MESSAGINGSYSTEMVALUES_SERVICEBUS;
