...
// This test requires vi.resetModules() for module isolation. It runs under
// vitest webworker config only. Excluded from Mocha and browser config
// (vi.resetModules does not isolate pre-bundled modules in browser mode).
describe('Global Utils', function () {
  ...
  it('should be separate instances with separate noop context managers', function () {
