...
| OTEL_EXPORTER_OTLP_METRICS_ENDPOINT                      | The endpoint to send metrics to. By default `http://localhost:4318/v1/metrics` will be used. `v1/metrics` will not be appended automatically and has to be added explicitly.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| OTEL_EXPORTER_OTLP_METRICS_DEFAULT_HISTOGRAM_AGGREGATION | The default aggregation to use for histogram instruments. Valid values are `explicit_bucket_histogram` and `base2_exponential_bucket_histogram`. By default `explicit_bucket_histogram` is used.                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
