...
* fix(otlp-exporter-base): re-throw `abortController.signal.reason` on fetch timeout instead of wrapping in a generic `Error` [#6921](https://github.com/open-telemetry/opentelemetry-js/pull/6921) @Babul422
