...
* feat(otlp-exporter-base, otlp-grpc-exporter-base): add an option to let user prepend their own user-agent string in HTTP & GRPC exporters [#5928](https://github.com/open-telemetry/opentelemetry-js/pull/5928) @david-luna
