...
This example shows how to use [@opentelemetry/tracer-sdk](https://github.com/open-telemetry/opentelemetry-js/tree/master/packages/opentelemetry-tracer-sdk) to instrument a simple Node.js application - e.g. a batch job.
...
- For more information on tracer-sdk, visit: <https://github.com/open-telemetry/opentelemetry-js/tree/master/packages/opentelemetry-tracer-sdk>
