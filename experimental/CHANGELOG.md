...
* feat(instrumentation-http): Add support for server span semantic conventions 1.27 [#4978](https://github.com/open-telemetry/opentelemetry-js/pull/4978) @dyladan
