...
export class SimpleFixedSizeExemplarReservoir extends FixedSizeExemplarReservoirBase {
  ...
  private _findBucketIndex(_value: number, _timestamp: HrTime, _attributes: SpanAttributes, _ctx: Context) {
  ...
  offer(value: number, timestamp: HrTime, attributes: SpanAttributes, ctx: Context): void {
