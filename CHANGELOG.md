...
* feat(sdk-trace-node): support `xray-lambda` Propagator via `OTEL_PROPAGATORS` environment variable [#4685](https://github.com/open-telemetry/opentelemetry-js/pull/4685) @martinkuba
