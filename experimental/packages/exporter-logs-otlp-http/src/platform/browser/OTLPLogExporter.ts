...
import type { IExportLogServiceRequest } from "@opentelemetry/otlp-transformer";
...
export class OTLPLogExporter
  extends OTLPExporterBrowserBase<ReadableLogRecord, IExportLogServiceRequest>
  implements LogRecordExporter
{
  constructor(config: OTLPExporterConfigBase = {}) {
    // load  OTEL_EXPORTER_OTLP_LOGS_TIMEOUT env var
    super({ timeoutMillis: getEnv().OTEL_EXPORTER_OTLP_LOGS_TIMEOUT, ...config });
    this._headers = {
      ...this._headers,
  ...
  convert(logRecords: ReadableLogRecord[]): IExportLogServiceRequest {
