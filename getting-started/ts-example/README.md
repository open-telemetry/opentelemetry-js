...
## Tracing Your Application with OpenTelemetry ([link to JS version](../#tracing-your-application-with-opentelemetry))
...
### Setting up a Tracing Backend ([link to JS version](../#setting-up-a-tracing-backend))
...
### Trace Your NodeJS Application ([link to JS version](../#trace-your-nodejs-application))
...
#### Install the required OpenTelemetry libraries ([link to JS version](../#install-the-required-opentelemetry-libraries))
...
#### Initialize a global tracer ([link to JS version](../#initialize-a-global-tracer))
...
#### Initialize and Register a Trace Exporter ([link to JS version](../#initialize-and-register-a-trace-exporter))
...
## Collect Metrics Using OpenTelemetry ([link to JS version](../#collect-metrics-using-opentelemetry))
...
### Set up a Metrics Backend ([link to JS version](../#set-up-a-metrics-backend))
...
### Monitor Your NodeJS Application ([link to JS version](../#monitor-your-nodejs-application))
...
#### Install the required OpenTelemetry metrics libraries ([link to JS version](../#install-the-required-opentelemetry-metrics-libraries))
...
#### Initialize a meter and collect metrics ([link to JS version](../#initialize-a-meter-and-collect-metrics))
...
#### Initialize and register a metrics exporter ([link to JS version](../#initialize-and-register-a-metrics-exporter))
