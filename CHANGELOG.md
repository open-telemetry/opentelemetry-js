...
* fix(opentelemetry-resources): the custom value from env variable for service.instance.id should take priority over random uuid as backup [#](https://github.com/open-telemetry/opentelemetry-js/pull/) @maryliag
