...
wget https://github.com/grpc-ecosystem/grpc-gateway/releases/download/v1.9.6/protoc-gen-grpc-gateway-v1.9.6-darwin-x86_64 \
    && chmod +x protoc-gen-grpc-gateway-v1.9.6-darwin-x86_64 \
    && sudo ln -s -f ${DIR}/protoc-gen-grpc-gateway-v1.9.6-darwin-x86_64 /usr/local/bin/protoc-gen-grpc-gateway
