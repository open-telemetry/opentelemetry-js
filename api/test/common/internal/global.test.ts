...
// This test requires vi.resetModules() for module isolation, so it only runs
// under vitest (webworker + browser configs). Excluded from Mocha.
describe('Global Utils', function () {
  let api1: typeof import('../../../src');
  let api2: typeof import('../../../src');
