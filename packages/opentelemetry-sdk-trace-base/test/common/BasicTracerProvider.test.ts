...
describe.skip('when attribute value length limit is defined via env', () => {
...
describe.skip('when attribute count limit is defined via env', () => {
  const envSource = process.env;
  ...
  it('should have span attribute countlimits value same as general limit value', () => {
